...
<body>
    ...
    <div class="container mt-3">
        <div class="card">
            <div class="card-header">@lang('messages.edit-e')</div>
            @if (Session::has('fail'))
            ...
            <div class="card-body">
                <form action="{{ route('employees.update')}}" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="firstname" value="{{$employee->firstname}}" class="form-control" id="formGroupExampleInput" placeholder="@lang('messages.p-fn')">
                  @error('firstname')
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="lastname" value="{{$employee->lastname}}" class="form-control" id="formGroupExampleInput" placeholder="@lang('messages.p-ln')">
                  @error('lastname')
                    <span class="text-danger">{{$message}}</span>
                  @enderror
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" name="email" value="{{$employee->email}}" class="form-control" id="formGroupExampleInput2" placeholder="@lang('messages.p-email')">
                  @error('email')
                    <span class="text-danger">{{$message}}</span>
                  @enderror
                  <div class="mb-3 mt-2">
                    <label for="formGroupExampleInput2" class="form-label">@lang('messages.phone')</label>
                    <input type="number" name="phone" value="{{$employee->phone}}" class="form-control" id="formGroupExampleInput2" placeholder="@lang('messages.p-phone')">
                  @error('phone')
                    <span class="text-danger">{{$message}}</span>
                  @enderror
