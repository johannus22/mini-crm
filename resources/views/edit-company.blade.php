...
<body>
    ...
    <div class="container mt-3">
        <div class="card">
            <div class="card-header">@lang('messages.edit-c')</div>
            @if (Session::has('fail'))
            ...
            <div class="card-body">
                <form action="{{ route('companies.update')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{$company->name}}" class="form-control" id="formGroupExampleInput" placeholder="@lang('messages.p-company')">
                  @error('name')
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" name="email" value="{{$company->email}}" class="form-control" id="formGroupExampleInput2" placeholder="@lang('messages.p-email')">
                  @error('email')
                    <span class="text-danger">{{$message}}</span>
                  @enderror
                </div>
                <!--this stalled me hahahaha-->
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="website" value="{{$company->website}}" class="form-control" id="formGroupExampleInput2" placeholder="@lang('messages.p-web')">
                  @error('website')
                    <span class="text-danger">{{$message}}</span>
                  @enderror
